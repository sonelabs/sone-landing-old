    ...
    <section className="relative pt-32 pb-20 md:pt-40 md:pb-32 overflow-hidden">
      ...
      <div className="container mx-auto px-4 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        <div className="max-w-xl mx-auto lg:mx-0 text-center lg:text-left">
          <div className="inline-block mb-4 px-3 py-1.5 bg-eye-teal/10 rounded-full border border-eye-teal/20 opacity-0 animate-fade-in">
            <span className="text-eye-teal text-sm font-medium flex items-center gap-1.5">
              <img src="/lovable-uploads/b237b712-6af2-4ad8-9a96-c8f1507d4836.png" alt="Eye Logo" className="h-4 w-4" />
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4 opacity-0 animate-fade-in animate-delay-400">
            <Button className="w-full sm:w-auto bg-eye-teal hover:bg-eye-teal/90 text-eye-black shadow-md hover:shadow-xl transition-all duration-300 text-base font-medium px-6 py-6 h-auto">
              Get Early Access
            </Button>
            <Button variant="outline" className="w-full sm:w-auto border-eye-teal/20 text-eye-teal hover:bg-eye-teal/5 text-base font-medium px-6 py-6 h-auto">
              Watch Demo
            </Button>
          </div>
        ...
        <div className="relative flex items-center justify-center opacity-0 animate-scale-fade animate-delay-400">
          ...
          >
            <div className="absolute inset-0 rounded-full bg-gradient-to-r from-eye-teal/5 to-eye-light-teal/10 flex items-center justify-center overflow-hidden">
              <div className="absolute w-64 h-64 md:w-72 md:h-72 rounded-full border-2 border-eye-teal/20 animate-spin-slow"></div>
              <div className="absolute w-48 h-48 md:w-56 md:h-56 rounded-full border border-eye-teal/10"></div>
              
              <div className="relative w-36 h-36 md:w-44 md:h-44 rounded-full bg-white shadow-lg ring-1 ring-eye-teal/10 ring-glow flex items-center justify-center">
                <div className="absolute w-full h-full rounded-full animate-pulse-glow">
                  <div className="w-full h-full rounded-full bg-gradient-to-r from-eye-teal/20 to-eye-light-teal/20 blur-xl"></div>
                </div>
                
                <div className="relative flex items-center justify-center">
                  <img 
                    src="/lovable-uploads/b237b712-6af2-4ad8-9a96-c8f1507d4836.png" 
                    alt="Eye Logo" 
              ...
              <div className="absolute top-1/2 -translate-y-1/2 -right-10 w-12 h-12 bg-white/90 backdrop-blur rounded-full shadow-lg flex items-center justify-center animate-float">
                <MousePointer className="h-5 w-5 text-eye-teal" />
              </div>
              ...
              <div className="absolute bottom-10 right-10 w-14 h-14 glass-card rounded-full shadow-lg flex items-center justify-center animate-float" style={{ animationDelay: '1s' }}>
                <Zap className="h-6 w-6 text-eye-teal" />
              </div>
            </div>
          </div>
        </div>
